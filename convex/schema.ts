...
export default defineSchema({
  ...
  strategySetups: defineTable({
    ...
    rationaleSummary: v.string(),
    createdAt: v.number(),
    lastReviewedAt: v.number(),
    entryPrice: v.optional(v.number()),
    stopPrice: v.optional(v.number()),
    targetPrice: v.optional(v.number()),
    entryTriggeredAt: v.optional(v.number()),
    completedAt: v.optional(v.number()),
    parentSetupId: v.optional(v.id("strategySetups")),
    isActive: v.boolean(),
  })
    .index("by_agentSlug_marketSymbol", ["agentSlug", "marketSymbol"])
    .index("by_agentSlug_marketSymbol_isActive", [
      "agentSlug",
      "marketSymbol",
      "isActive",
    ]),
