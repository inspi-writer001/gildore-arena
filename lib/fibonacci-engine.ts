  ...
  const trace: VisualTrace = {
    ...
    annotations: [
      ...
      },
      {
        ...
        geometry: {
          kind: "zone",
          startBarIndex: Math.max(highIndex - 8, 0),
      ...
      },
      {
        ...
        type: "entry",
        label: "Trigger level",
        detail: "The engine marks the midpoint of the reaction band as the current trigger.",
        revealStep: 3,
        geometry: {
          kind: "marker",
          position: {
            barIndex: Math.max(window.length - 8, 0),
            price: entry,
          },
          text: "Entry",
          tone: "entry",
      ...
      },
      {
        ...
        type: "stop-loss",
        label: "Risk line",
        detail: "Stop sits below the reaction band to protect the retracement failure case.",
        revealStep: 3,
        geometry: {
          kind: "marker",
          position: {
            barIndex: Math.max(window.length - 16, 0),
            price: stopLoss,
          },
          text: "SL",
          tone: "stop",
      ...
      },
      {
        ...
        detail: "Target projects beyond the swing high using a continuation extension.",
        revealStep: 3,
        geometry: {
          kind: "marker",
          position: {
